/***
 * Draw a concentric circles logo in multiple colours.
 * With text in the middle saying DrJon EA
 * Put this on a screen using DVI
 * -- Jon Durrant Oct-2025
 */
...
int main()
{
	...
	while(1)
	{
        ...
        Paint_DrawString_CN(1, 60, "��ӭʹ��", &Font24CN, Scale3_WHITE, Scale3_BLUE);
